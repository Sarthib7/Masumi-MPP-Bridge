...
| [Visual architecture](visual-architecture.md) | Mermaid diagrams for the current bridge, MPP request lifecycle, and future multi-rail model |
| [Architecture](architecture.md) | System diagram, Masumi/Sokosumi layers, agent catalog modes, API keys (registry vs marketplace) |
| [Roadmap](roadmap.md) | Current execution plan: multi-rail architecture, MPP-first rollout, production hardening gates |
...
| [PRD](prd.md) | Product requirements document (proposal / historical context) |
